...
variable "engine_mode" {
  description = "The database engine mode. Valid values: provisioned as of January 2025"
  type        = string
  default     = "provisioned"
}
...
variable "backtrack_window" {
  description = "The target backtrack window, in seconds. Only available for aurora mysql as of January 2025. To disable backtracking, set this value to 0. Defaults to 0. Must be between 0 and 259200 (72 hours)"
  type        = number
  default     = 0
}
